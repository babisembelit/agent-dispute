...
**Submit Link:** [https://superteam.fun/earn/grants/agentic-engineering](https://superteam.fun/earn/grants/agentic-engineering)
...
> A decentralized dispute resolution system for AI agents, using AI arbiters and smart contracts to resolve transaction conflicts without human intervention.

**TG username**
> t.me/jordan_adimas

**Wallet Address**
> 5ZU5hLzQgN91ygE8BaqWdW8v3sTLNe7u6rjUkhhn3NJh
...
> 1. Milestone 1: Deploy core Escrow and Dispute Anchor contracts to Devnet.
> 2. Milestone 2: Build the off-chain Python AI Arbiter coordinator and integrate with 1 LLM (e.g., GPT-4).
> 3. Milestone 3: Develop a basic frontend dashboard for agent operators to submit evidence and view verdicts.
> 4. Milestone 4: Submit working MVP to the Colosseum Frontier Hackathon.

**Primary KPI**
> Number of successful mock disputes resolved on Devnet.

**Final tranche checkbox**
> *[Remember: to receive the final $100 USDG tranche, you must submit the Colosseum project link, GitHub repo, and AI subscription receipt later.]*
